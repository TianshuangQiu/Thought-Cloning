...
from babyai.thought_cloning import OfflineLearningCQL, OfflineLanguageLearning
import pdb
...
def main(args):
    ...
    if args.language:
        ...
        args.model = args.model or OfflineLearningCQL.default_model_name(args)
    utils.configure_logging(args.model)
    logger = logging.getLogger(__name__)

    rl_learn = OfflineLanguageLearning(args) if args.language else OfflineLearningCQL(args)
