...
from babyai.thought_cloning import OfflineLearningIQL, OfflineLanguageLearning
import pdb
...
def main(args):
    ...
    if args.language:
        ...
        args.model = args.model or OfflineLearningIQL.default_model_name(args)
    utils.configure_logging(args.model)
    logger = logging.getLogger(__name__)

    rl_learn = OfflineLanguageLearning(args) if args.language else OfflineLearningIQL(args)
